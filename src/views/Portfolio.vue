    ...
    return {
      products: [
        ...
        { header: 'なんちゃってスクラッチなサイト',
            ...
            text:
              'Web制作の基礎工程を知るために1ヶ月ほどで制作したサイト。デザインは講座のコードをアレンジしたものですが、丁寧に理解しつつ作ることで、マークアップやJavaScriptプログラミングの理論をしっかりと把握できました。全体的にシンプルで泥臭い内容ですが、初期の開発経験としてはむしろベストな選択だったと思っています。ただ、webpackでバンドル化などを試しても初期表示が遅い...。速度改善案を模索中です。',
